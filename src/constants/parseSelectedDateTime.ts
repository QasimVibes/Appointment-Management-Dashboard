export const parseSelectedDateTime = (selectedDate: string, selectedTime: string) => {
  ...
  return { start: formatDateWithoutTimezone(startDate), end: formatDateWithoutTimezone(endDate) };
};